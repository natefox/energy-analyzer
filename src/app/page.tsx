    ...
    <div className="space-y-12">
      <section className="text-center py-12">
        ...
        <p className="mt-4 text-xl text-gray-600 max-w-2xl mx-auto">
          Compare rate plans and analyze your actual usage data. Supports SDG&E and Southern
          California Edison.
        </p>
      </section>
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="mt-2 text-gray-600">
            See which rate plan saves you the most based on your estimated usage pattern. Compare
            side-by-side.
          </p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="mt-2 text-gray-600">
            Upload your utility CSV and see exactly how your energy costs break down by time of use.
          </p>
        </Link>
      </section>
